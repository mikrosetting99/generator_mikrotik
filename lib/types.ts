...
export interface HotspotEntry {
  ...
  /**
   * Buka akses ke wa.me/*.whatsapp.com sebelum login, supaya tombol WhatsApp
   * di halaman login (menu Halaman Login Hotspot) bisa dibuka klien.
   */
  whatsappWalledGarden: boolean;
}
