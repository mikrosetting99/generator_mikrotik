...
import { biayaPesanan, saldoKoin } from "@/lib/koin/saldo";
    ...
    <div>
      ...
      {biaya > 0 && (
        <div className="mt-4">
          {cukup ? (
            <Note>
              Menyimpan pesanan ini memotong <b className="text-ink">{biaya} koin</b>. Saldo Anda{" "}
              {saldo.toLocaleString("id-ID")} koin.
            </Note>
          ) : (
            <Note tone="warn">
